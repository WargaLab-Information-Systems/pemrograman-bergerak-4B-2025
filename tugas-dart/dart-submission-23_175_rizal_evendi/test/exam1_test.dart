...
void main() {
  ...
  test('Exam 1 - TODO 2', () {
    ...
    expect(
      circleArea(7),
      isA<double>(),
      reason: "Fungsi tidak mengembalikan tipe data double (tes angka positif)",
    );
    expect(
      circleArea(-10),
      isA<double>(),
      reason: "Fungsi tidak mengembalikan tipe data double (tes angka negatif)",
    );

    // Test untuk memeriksa hasil kembalian dari method
    expect(
      circleArea(7),
      equals(153.93804002589985),
      reason: "Apabila nilai r='7', hasil kembalian bukan 153.93804002589985",
    );
    expect(
      circleArea(20),
      equals(1256.6370614359173),
      reason: "Apabila nilai r='20', hasil kembalian bukan 1256.6370614359173",
    );
    expect(
      circleArea(0),
      equals(0.0),
  ...
  test('Exam 1 - TODO 3', () {
    ...
    expect(
      parseAndAddOne(null),
      isNull,
      reason: "Jika input adalah null, fungsi seharusnya mengembalikan null.",
    );
